...
-- ----------------------------
DROP TABLE IF EXISTS `get_house`;
CREATE TABLE `get_house` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '房源id',
  `district` varchar(255) DEFAULT NULL COMMENT '区域',
  `role` int(11) DEFAULT NULL COMMENT '发布信息角色 1经纪人 0 个人',
...
CREATE TABLE `recruit` (
  ...
  `role` tinyint(4) DEFAULT NULL COMMENT '角色 1-经纪人 0-个人',
  `price` varchar(255) DEFAULT NULL COMMENT '薪资区间',
...
CREATE TABLE `sell_house` (
  ...
  `role` tinyint(4) DEFAULT NULL COMMENT '角色 1-经纪人 0-个人',
  `price` varchar(255) DEFAULT NULL COMMENT '价格区间',
  `area` varchar(255) DEFAULT NULL COMMENT '面积区间',
  `phone` varchar(45) DEFAULT NULL COMMENT '联系电话',
  `district` varchar(255) DEFAULT NULL COMMENT '区域',
  ...
  `city` varchar(255) DEFAULT NULL COMMENT '市',
  `area1` varchar(255) DEFAULT NULL COMMENT '区县',
  `des` varchar(255) DEFAULT NULL COMMENT '详情',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `identity` tinyint(4) DEFAULT '0' COMMENT '认证消息  0未认证  1认证',
  PRIMARY KEY (`id`)
...
CREATE TABLE `user` (
  ...
  `user_city` varchar(255) DEFAULT NULL COMMENT '城市',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
