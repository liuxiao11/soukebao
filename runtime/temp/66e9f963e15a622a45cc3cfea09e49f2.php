...
<div class="layui-body my-body">
    <div class="layui-tab layui-tab-card my-tab" lay-filter="card" lay-allowClose="true">
        <ul class="layui-tab-title">
            <li class="layui-this" lay-id="1"><span><i class="layui-icon">&#xe638;</i>卖房审核页</span></li>
        </ul>
            ...
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo url('User/agentOut',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini layui-btn-danger" lay-event="del">不通过</a>
                    </td>
                </tr>
