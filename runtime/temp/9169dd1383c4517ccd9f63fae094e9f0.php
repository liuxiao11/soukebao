...
<div class="layui-body my-body">
    <div class="layui-tab layui-tab-card my-tab" lay-filter="card" lay-allowClose="true">
        <ul class="layui-tab-title">
            <li class="layui-this" lay-id="1"><span><i class="layui-icon">&#xe638;</i>分类列表页</span></li>
        </ul>
        <div class="layui-tab-content" style="margin-left: 20px">
            <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
                <legend>分类列表</legend>
                <legend><a href="<?php echo url('System/add'); ?>" class="layui-btn btn-add btn-default" id="btn-add"
                           style="float: right">添加</a></legend>
            </fieldset>
            ...
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('System/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini layui-btn-normal"
                           lay-event="edit">编辑</a>
                        <a href="<?php echo url('System/del',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini layui-btn-danger"
                           lay-event="del">删除</a>
                    </td>
                </tr>
