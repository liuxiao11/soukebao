...
<div class="layui-body my-body">
    <div class="layui-tab layui-tab-card my-tab" lay-filter="card" lay-allowClose="true">
        <ul class="layui-tab-title">
            <li class="layui-this" lay-id="1"><span><i class="layui-icon">&#xe638;</i>卖房信息修改页</span></li>
        </ul>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="name" lay-verify="required" placeholder="请输入" autocomplete="off"
                               class="layui-input" value="<?php echo $list['name']; ?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="user_id" lay-filter="aihao">
                            <option value=""></option>
                            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($list['user_id'] != $vo['id']): ?>
                            <option value="<?php echo $vo['id']; ?>" selected=""><?php echo $vo['user_name']; ?></option>
                            <?php else: ?>
                            <option value="<?php echo $vo['id']; ?>" selected=""><?php echo $vo['user_name']; ?></option>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="phone" lay-verify="required" placeholder="请输入" autocomplete="off"
                               class="layui-input" value="<?php echo $list['phone']; ?>">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="price" lay-verify="required" lay-search="">
                            ...
                            <option value="4500以上">4500以上</option>
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="area" lay-verify="required" lay-search="">
                            ...
                            <option value="350以上">350以上</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="address" lay-verify="required" placeholder="请输入" autocomplete="off"
                               class="layui-input" value="<?php echo $list['address']; ?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="type" lay-filter="aihao">
                            <option value=""></option>
                            <?php if(is_array($category) || $category instanceof \think\Collection || $category instanceof \think\Paginator): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($list['type'] == $v['id']): ?>
...
<script type="text/javascript">
    layui.use(['form', 'layedit', 'laydate', 'element'], function () {
        ...
        form.on('submit(sub)', function (data) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('Info/editGet'); ?>",
                data: formData,//这里data传递过去的是序列化以后的字符串
                success: function (data) {
                    if (data) {
                        window.location.href = `/admin/Info/infoGet`;
                    }
                }
            });
        });
