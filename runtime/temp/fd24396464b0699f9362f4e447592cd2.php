        ...
        <div class="layui-tab-content" style="margin-left: 20px">
            ...
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('User/getPass',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini"
                           lay-event="detail">审核通过</a>
                        <a href="<?php echo url('User/getOut',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini layui-btn-danger" lay-event="del">不通过</a>
                    </td>
                </tr>
