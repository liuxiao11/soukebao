...
<div class="layui-body my-body">
    <div class="layui-tab layui-tab-card my-tab" lay-filter="card" lay-allowClose="true">
        <ul class="layui-tab-title">
            <li class="layui-this" lay-id="1"><span><i class="layui-icon">&#xe638;</i>用户列表页</span></li>
        </ul>
        <div class="layui-tab-content" style="margin-left: 20px">
            ...
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td><img src="<?php echo $vo['wx_avaurl']; ?>" style="width: 20px"></td>
                    ...
                    <td>
                        <a href="<?php echo url('User/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini layui-btn-normal"
                           lay-event="edit">编辑</a>
                        <a href="<?php echo url('User/del',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini layui-btn-danger"
                           lay-event="del">删除</a>
                    </td>
                </tr>
