        ...
        <div class="layui-tab-content" style="margin-left: 20px">
            ...
            <form class="layui-form layui-form-pane" action="" id="formdata" enctype="multipart/form-data" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <?php if($list['lb_img'] == ''): else: if(is_array($list['lb_img']) || $list['lb_img'] instanceof \think\Collection || $list['lb_img'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['lb_img'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>

                    <img src="/uploads/<?php echo $v; ?>" style="width: 180px ;margin-left: 100px">
                ...
                <div class="layui-form-item">
                    ...
                    <?php if($list['get_img'] == ''): else: ?>
                        <img src="/uploads/<?php echo $list['get_img']; ?>" style="width: 180px">
                    <?php endif; ?>
                </div>
                <div class="layui-form-item">
                    ...
                    <?php if($list['get_type_img'] == ''): else: ?>
                    <img src="/uploads/<?php echo $list['get_type_img']; ?>" style="width: 180px">
                    <?php endif; ?>
                </div>
                <div class="layui-form-item">
                    ...
                    <?php if($list['publish_img'] == ''): else: ?>
                    <img src="/uploads/<?php echo $list['publish_img']; ?>" style="width: 180px">
                    <?php endif; ?>
                </div>
                <hr>
                <div class="layui-form-item">
