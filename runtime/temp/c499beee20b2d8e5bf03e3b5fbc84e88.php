<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\php\PHPTutorial\WWW\soukebao\public/../application/admin\view\system\edit_admin.html";i:1533885594;s:73:"D:\php\PHPTutorial\WWW\soukebao\application\admin\view\public\header.html";i:1533883808;s:76:"D:\php\PHPTutorial\WWW\soukebao\application\admin\view\public\header_js.html";i:1533027498;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form layui-form-pane" action="" id="formdata" method="post" enctype="multipart/form-data">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <?php else: ?>
                        <input type="text" name="admin_name" lay-verify="required" placeholder="请输入" autocomplete="off"
                               class="layui-input" value="<?php echo $list['admin_name']; ?>">
                        <?php endif; ?>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="kf_phone" autocomplete="off" placeholder="请输入电话" lay-verify="required"
                               class="layui-input" value="<?php echo $list['kf_phone']; ?>">
                    </div>
                </div>
                <!--<div class="layui-form-item">-->
                    ...
                    <!--<div class="layui-input-block">-->
                        ...
                        <!--<input type="file" name="image[]" /> <br>-->
                        <!--<input type="file" name="image[]" /> <br>-->
                        <!--<?php if(is_array($list['img']) || $list['img'] instanceof \think\Collection || $list['img'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['img'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>-->
                            <!--<img src="/uploads/<?php echo $v; ?>" style="width: 180px">-->
...
<script type="text/javascript">
    layui.use(['form', 'layedit', 'laydate', 'element'], function () {
        ...
        form.on('submit(sub)', function (data) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('System/editAdmin'); ?>",
