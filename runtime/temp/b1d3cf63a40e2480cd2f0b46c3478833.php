...
<div class="layui-body my-body">
    <div class="layui-tab layui-tab-card my-tab" lay-filter="card" lay-allowClose="true">
        <ul class="layui-tab-title">
            <li class="layui-this" lay-id="1"><span><i class="layui-icon">&#xe638;</i>求购信息页</span></li>
        </ul>
        <div class="layui-tab-content" style="margin-left: 20px">
            <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
                <legend>求购信息</legend>
            </fieldset>
            <a href="<?php echo url('Info/addGet'); ?>" class="layui-btn btn-add btn-default" id="btn-add"  style="float: left">添加</a>
            <form class="layui-form layui-form-pane" method="post" action="" style="float: right">
                <span class="layui-form-label">搜索条件：</span>
                <div class="layui-input-inline">
                    <input type="text" autocomplete="off" placeholder="请输入搜索内容" class="layui-input" value=""
                           name="search" id="formdata">
                </div>
            ...
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('Info/editGet',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini layui-btn-normal"
                           lay-event="edit">编辑</a>
                        <a href="<?php echo url('Info/delGet',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini"
