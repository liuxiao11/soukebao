...
<div class="layui-body my-body">
    <div class="layui-tab layui-tab-card my-tab" lay-filter="card" lay-allowClose="true">
        <ul class="layui-tab-title">
            <li class="layui-this" lay-id="1"><span><i class="layui-icon">&#xe638;</i>卖房信息页</span></li>
        </ul>
        <div class="layui-tab-content" style="margin-left: 20px">
            <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
                <legend>卖房信息</legend>
            </fieldset>
            <a href="<?php echo url('Info/add'); ?>" class="layui-btn btn-add btn-default" id="btn-add" style="float: left">添加</a>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('Info/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini layui-btn-normal"
                           lay-event="edit">编辑</a>
                        <a href="<?php echo url('Info/del',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini" lay-event="detail">删除</a>
                    </td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
