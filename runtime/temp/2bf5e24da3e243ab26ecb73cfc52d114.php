...
<div class="layui-body my-body">
    <div class="layui-tab layui-tab-card my-tab" lay-filter="card" lay-allowClose="true">
        ...
        <div class="layui-tab-content" style="margin-left: 20px">
            ...
            <a href="<?php echo url('Info/addRent'); ?>" class="layui-btn btn-add btn-default" id="btn-add"  style="float: left">添加</a>
            ...
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('Info/editRent',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini layui-btn-normal"
                           lay-event="edit">编辑</a>
                        <a href="<?php echo url('Info/delRent',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini"
