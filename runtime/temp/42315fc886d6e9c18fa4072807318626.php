...
<div class="layui-body my-body">
    <div class="layui-tab layui-tab-card my-tab" lay-filter="card" lay-allowClose="true">
        <ul class="layui-tab-title">
            <li class="layui-this" lay-id="1"><span><i class="layui-icon">&#xe638;</i>租房信息修改页</span></li>
        </ul>
        <div class="layui-tab-content" style="margin-left: 20px">
            <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
                <legend>租房信息修改</legend>
            </fieldset>
...
<script type="text/javascript">
    layui.use(['form', 'layedit', 'laydate', 'element'], function () {
        ...
        form.on('submit(sub)', function (data) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('Info/editRent'); ?>",
                data: formData,//这里data传递过去的是序列化以后的字符串
                success: function (data) {
                    if (data) {
                        window.location.href = `/admin/Info/infoRent`;
                    }
                }
            });
        });
